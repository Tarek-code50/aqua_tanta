          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-brand-500 to-brand-700 rounded-lg flex items-center justify-center text-white font-bold text-xl">A</div>
                <span className="text-2xl font-bold text-white font-cairo">Aqua Tanta</span>
              </div>
              <p className="text-slate-400 leading-relaxed max-w-sm">
                Providing Tanta with the purest water solutions since 2015. We believe every family deserves clean, healthy water.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>El-Galaa St., Tanta,<br/>Gharbia Governorate</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                 <a href="#" className="w-10 h-10 bg-slate-800 hover:bg-brand-600 rounded-full flex items-center justify-center transition-all hover:-translate-y-1">
                   <Facebook size={20} />
                 </a>
                 <a href="#" className="w-10 h-10 bg-slate-800 hover:bg-pink-600 rounded-full flex items-center justify-center transition-all hover:-translate-y-1">
                   <Instagram size={20} />
                 </a>
              </div>
              <div className="mt-8">
                 <a href="#login" className="text-xs text-slate-600 hover:text-slate-400 transition-colors uppercase tracking-widest">{t.nav.login}</a>
              </div>
            </div>
          </div>
