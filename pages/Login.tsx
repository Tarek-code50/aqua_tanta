    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 transition-colors p-4">
      <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-100 dark:border-slate-700">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-brand-600 rounded-full flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4">A</div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t.admin.login.title}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{t.admin.login.email}</label>
            <input 
              type="email" 
              required
              value={email}
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{t.admin.login.password}</label>
            <input 
              type="password" 
              required
              value={password}
        ...
        <div className="mt-6 text-center">
          <a href="#home" className="text-sm text-slate-500 hover:text-brand-600">Back to Website</a>
        </div>
      </div>
    </div>
  );
